#
# Module manifest for module azure.databricks.cicd.tools.asos'
#
...
@{
    ...
    RootModule = 'azure.databricks.cicd.tools.asos.psm1'
    ...
    Description = 'PowerShell module to help with Azure Databricks CI & CD Scenarios by simplifying the API or CLI calls into idempotent commands. See https://github.com/DataThirstLtd/azure.databricks.cicd.tools.asos & https://datathirst.net'
    ...
    PrivateData = @{
        PSData = @{
            ...
            ProjectUri = 'https://github.com/DataThirstLtd/azure.databricks.cicd.tools.asos'
    ...
    HelpInfoURI = 'https://github.com/DataThirstLtd/azure.databricks.cicd.tools.asos'
